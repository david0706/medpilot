...
export const Hero = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen pt-20 md:pt-40 relative overflow-hidden">
      ...
      >
        <Balancer>Découvrez la dictée médicale intelligente</Balancer>
      </motion.h1>
      <motion.p
        initial={{
          y: 40,
      ...
      >
        <Balancer>
          Dictez librement, notre IA structure automatiquement vos comptes rendus selon vos propres modèles
        </Balancer>
      </motion.p>
      <motion.div
        initial={{
